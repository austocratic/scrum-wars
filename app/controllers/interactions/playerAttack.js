    ...
    return new Promise((resolve, reject) => {
        ...
        firebase.get('character', 'user_id', userID)
            .then( character => {
                ...
                //Get player character's zone (to be used in zone alert)
                firebase.get('zone', 'channel_id', payload.channel_id)
                    .then(()=>{
                ...
                firebase.get('character', 'name', targetPlayer)
                    .then( target => {
                        ...
                        if (targetDefending) {
                            ...
                            //TODO for phase 1 simplicity: damage will be a random # up to strength value
                            //Generate a random number based on character strength
                            var randomDamage = getRandomIntInclusive(1, playerCharacter.strength);
