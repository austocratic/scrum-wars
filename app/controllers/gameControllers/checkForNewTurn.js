...
const checkForNewTurn = (gameObjects) => {
    ...
    let nextTurnStartTime = (gameObjects.currentMatch.props.date_started + (gameObjects.currentMatch.props.number_turns * (gameObjects.game.state.match.settings.turn_length_minutes * 60000)));
